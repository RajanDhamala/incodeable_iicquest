          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center space-x-3">
              {!isLoaded ? (
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <SignOutButton>
                    <Button
                      variant="outline"
                      size="sm"
                      className="border-red-200 text-red-600 hover:bg-red-50 bg-white/50"
                    >
                ...
                <SignInButton>
                  <Button className="bg-gradient-to-r from-orange-500 to-teal-600 hover:from-orange-600 hover:to-teal-700 text-white shadow-lg hover:shadow-xl transition-all">
